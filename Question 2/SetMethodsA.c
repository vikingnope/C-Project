 ...
 */
void initSet(GenSet *set, int elementType, int initSize, getSizeOfFP getSizeOfFP, compareFP compareFP, addToSetFP addToSetFP, displayFP displayFP){
...
GenSet *unionSet(GenSet *set1, GenSet *set2) {
    ...
    initSet(result, 3, set1->memorySize + set2->memorySize, set1->FunctionPointers.getSizeOfFP, set1->FunctionPointers.compareFP, set1->FunctionPointers.addToSetFP, set1->FunctionPointers.displayFP);
...
GenSet *intersectSet(GenSet *set1, GenSet *set2) {
    ...
    initSet(result, 4, set1->memorySize, set1->FunctionPointers.getSizeOfFP, set1->FunctionPointers.compareFP, set1->FunctionPointers.addToSetFP, set1->FunctionPointers.displayFP);
...
GenSet *diffSet(GenSet *set1, GenSet *set2) {
    ...
    initSet(result, 5, set1->memorySize, set1->FunctionPointers.getSizeOfFP, set1->FunctionPointers.compareFP, set1->FunctionPointers.addToSetFP, set1->FunctionPointers.displayFP);
