...
GenSet *unionSet(GenSet *set1, GenSet *set2) {
    ...
    initSet(result, set1->elementType, set1->memorySize + set2->memorySize, set1->FunctionPointers.getSizeOfFP, set1->FunctionPointers.compareFP, set1->FunctionPointers.addToSetFP, set1->FunctionPointers.displayFP);
...
GenSet *intersectSet(GenSet *set1, GenSet *set2) {
    ...
    initSet(result, set1->elementType, set1->memorySize, set1->FunctionPointers.getSizeOfFP, set1->FunctionPointers.compareFP, set1->FunctionPointers.addToSetFP, set1->FunctionPointers.displayFP);
